...
public class BoilerpipeHTMLParser extends AbstractSAXParser implements BoilerpipeDocumentSource {
    ...
    /**
     * Constructs a {@link BoilerpipeHTMLParser} using a default HTML content
     * handler.
     */
    ...
    /**
     * Constructs a {@link BoilerpipeHTMLParser} using the given
     * {@link BoilerpipeHTMLContentHandler}.
     *
