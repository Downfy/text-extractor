...
public abstract class CommonTagActions {
    ...
    /**
     * Marks this tag as "ignorable", i.e. all its inner content is silently
     * skipped.
     */
     ...
     * <code>&lt;A&gt;</code> tag). Anchor tags may not be nested.
     *
     * There is a bug in certain versions of NekoHTML which still allows nested
     * tags. If boilerpipe encounters such nestings, a SAXException is thrown.
     */
    ...
    /**
     * Marks this tag a simple "inline" element, which generates whitespace, but
     * no new block.
     */
    ...
    /**
     * Marks this tag a simple "inline" element, which neither generates
     * whitespace, nor a new block.
     */
    ...
    private static final Pattern PAT_FONT_SIZE = Pattern
            .compile("([\\+\\-]?)([0-9])");
    /**
     * Explicitly marks this tag a simple "block-level" element, which always
     ...
     * <code>&lt;FONT&gt;</code> tag, which keeps track of the absolute and
     * relative font size.
     */
    ...
    /**
     * {@link CommonTagActions} for inline elements, which triggers some
     * {@link LabelAction} on the generated {@link TextBlock}.
     */
    ...
    /**
     * {@link CommonTagActions} for block-level elements, which triggers some
     * {@link LabelAction} on the generated {@link TextBlock}.
     */
