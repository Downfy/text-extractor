...
/**
 * Base class for definition a set of {@link TagAction}s that are to be used for
...
public abstract class TagActionMap extends HashMap<String, TagAction> {
    ...
    /**
     * Sets a particular {@link TagAction} for a given tag. Any existing
     * TagAction for that tag will be removed and overwritten.
     *
     * @param tag The tag (will be stored internally 1. as it is, 2. lower-case,
     * 3. upper-case)
    ...
    /**
     * Adds a particular {@link TagAction} for a given tag. If a TagAction
     * already exists for that tag, a chained action, consisting of the previous
     * and the new {@link TagAction} is created.
     *
     * @param tag The tag (will be stored internally 1. as it is, 2. lower-case,
     * 3. upper-case)
     * @param action The {@link TagAction}
