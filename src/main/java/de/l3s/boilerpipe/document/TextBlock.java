...
public class TextBlock implements Cloneable {
     ...
     * <code>null</code> if no such labels exist.
     *
     * NOTE: The returned instance is the one used directly in TextBlock. You
     * have full access to the data structure. However it is recommended to use
     * the label-specific methods in {@link TextBlock} whenever possible.
     *
     * @return Returns the set of labels, or <code>null</code> if no labels was
     * added yet.
     */
