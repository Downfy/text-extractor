...
/**
 * Estimates the "goodness" of a {@link BoilerpipeExtractor} on a given
 * document.
 *
...
public final class SimpleEstimator {
     ...
     * {@link BoilerpipeExtractor}, can we regard the extraction quality (too)
     * low?
     *
     * Works well with {@link DefaultExtractor}, {@link ArticleExtractor} and
     * others.
     *
     * @param dsBefore
     * @param dsAfter
