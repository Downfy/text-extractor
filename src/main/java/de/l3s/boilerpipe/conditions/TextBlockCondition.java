...
/**
 * Evaluates whether a given {@link TextBlock} meets a certain condition. Useful
 * in combination with {@link ConditionalLabelAction}.
 *
...
public interface TextBlockCondition {
    ...
    /**
     * Returns
     * <code>true</code> iff the given {@link TextBlock} tb meets the defined
     * condition.
     *
     * @param tb
