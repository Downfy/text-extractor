 ...
 * unless a minimum number of words in content blocks occur before this mark
 * (default: 60). This can be used in conjunction with an upstream
 * {@link TerminatingBlocksFinder}.
 *
