...
public final class PrintDebugFilter implements BoilerpipeFilter {
    ...
    /**
     * Returns the default instance for {@link PrintDebugFilter}, which dumps
     ...
     *
     * Only use this method if you are not going to dump the debug information
     * to
     * <code>System.out</code> -- for this case, use {@link #getInstance()}
     * instead.
     *
