...
/**
 * Fuses adjacent blocks if their distance (in blocks) does not exceed a certain
 * limit. This probably makes sense only in cases where an upstream filter
 * already has removed some blocks.
 *
