...
/**
 * Marks all blocks as content that: <ol> <li>are on the same tag-level as very
 * likely main content (usually the level of the largest block)</li> <li>have a
 * significant number of words, currently: at least 100</li> </ol>
 *
