...
public class HTMLElements {
    ...
    //
    /**
     * Initializes the element information. <p> <strong>Note:</strong> The
     * <code>getElement</code> method requires that the HTML elements are added
     * to the list in alphabetical order. If new elements are added, then they
     * <em>must</em> be inserted in alphabetical order.
     */
    static {
