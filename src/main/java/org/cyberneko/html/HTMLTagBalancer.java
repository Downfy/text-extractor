 ...
 * document authors make. This tag balancer can: <ul> <li>add missing parent
 * elements; <li>automatically close elements with optional end tags; and
 * <li>handle mis-matched inline element tags. </ul> <p> This component
 * recognizes the following features: <ul>
 ...
 * </ul> <p> This component recognizes the following properties: <ul>
 ...
 * <li>http://cyberneko.org/html/properties/balance-tags/current-stack </ul>
 *
 * @see HTMLElements
 *
 * @author Andy Clark
...
public class HTMLTagBalancer
     ...
     * </pre> <p> It seems that it is a waste of processing and memory to copy
     * the attributes for every start element even if there are no unbalanced
     * inline elements in the document. However, if the attributes are
     * <em>not</em> saved, then important attributes such as style information
     * would be lost.
     *
     * @author Andy Clark
     */
    public static class Info {
        ...
        //
        /**
         * Creates an element information object. <p> <strong>Note:</strong>
